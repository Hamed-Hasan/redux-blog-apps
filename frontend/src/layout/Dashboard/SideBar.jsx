...
const SideBar = () => {
    return (
        <div className="col-span-2 bg-[#0B1120] h-[calc(100vh-25px)] p-5 rounded-lg">
        <div class="flex flex-no-wrap">
            <ul className='flex gap-3  flex-col h-full'>
        <li className='text-white font-bold'>Admin Dashboard</li>
        <li className='text-white font-medium mt-3 hover:bg-slate-800 px-4 py-2 transition-all rounded-lg'>
          <Link to='bloglist'>Blog List</Link>
        </li>
        <li className='text-white font-medium hover:bg-slate-800 px-4 py-2 transition-all rounded-lg'>
          <Link to='addblog'> Add Blog </Link>
        </li>
        <li className='mt-auto text-white font-medium '>
          <Link to='/'> Back to Home </Link>
        </li>
      </ul>
{/* 
        <div style={{minHeight: "716px"}} class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
            <div class="px-8">
                ...
                <ul class="mt-12">
                    ...
                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            ...
                            <span class="text-sm ml-2"> <Link to='/addblog'>Add Blog</Link></span>
                        </a>
                    ...
                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            ...
                            <span class="text-sm ml-2"> <Link to='/bloglist'>Blog List</Link></span>
                        </a>
                    </li>
                    <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
